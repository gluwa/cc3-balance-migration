...
import '@polkadot/api-base/types/calls.ts';

import type { ApiTypes, AugmentedCall, DecoratedCallBase } from '@polkadot/api-base/types/index.ts';
import type { Bytes, Null, Option, Raw, Vec, u32 } from '@polkadot/types-codec/index.ts';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types/index.ts';
import type { BabeEquivocationProof, BabeGenesisConfiguration, Epoch, OpaqueKeyOwnershipProof } from '@polkadot/types/interfaces/babe/types.ts';
import type { CheckInherentsResult, InherentData } from '@polkadot/types/interfaces/blockbuilder/types.ts';
...
import type { AuthorityList, GrandpaEquivocationProof, SetId } from '@polkadot/types/interfaces/grandpa/types.ts';
import type { OpaqueMetadata } from '@polkadot/types/interfaces/metadata/types.ts';
import type { FeeDetails, RuntimeDispatchInfo } from '@polkadot/types/interfaces/payment/types.ts';
import type { AccountId, Balance, Block, Header, Index, KeyTypeId, Moment, Slot, Weight } from '@polkadot/types/interfaces/runtime/types.ts';
import type { RuntimeVersion } from '@polkadot/types/interfaces/state/types.ts';
import type { ApplyExtrinsicResult } from '@polkadot/types/interfaces/system/types.ts';
import type { TransactionSource, TransactionValidity } from '@polkadot/types/interfaces/txqueue/types.ts';
import type { IExtrinsic, Observable } from '@polkadot/types/types/index.ts';

export type __AugmentedCall<ApiType extends ApiTypes> = AugmentedCall<ApiType>;
export type __DecoratedCallBase<ApiType extends ApiTypes> = DecoratedCallBase<ApiType>;

declare module '@polkadot/api-base/types/calls.ts' {
