...
import '@polkadot/rpc-core/types/jsonrpc.ts';

import type { AugmentedRpc } from '@polkadot/rpc-core/types/index.ts';
import type { Metadata, StorageKey } from '@polkadot/types/mod.ts';
import type { Bytes, HashMap, Json, Null, Option, Text, U256, U64, Vec, bool, f64, u32, u64 } from '@polkadot/types-codec/index.ts';
import type { AnyNumber, Codec } from '@polkadot/types-codec/types/index.ts';
import type { ExtrinsicOrHash, ExtrinsicStatus } from '@polkadot/types/interfaces/author/types.ts';
import type { EpochAuthorship } from '@polkadot/types/interfaces/babe/types.ts';
import type { BeefySignedCommitment } from '@polkadot/types/interfaces/beefy/types.ts';
import type { BlockHash } from '@polkadot/types/interfaces/chain/types.ts';
import type { PrefixedStorageKey } from '@polkadot/types/interfaces/childstate/types.ts';
import type { AuthorityId } from '@polkadot/types/interfaces/consensus/types.ts';
import type { CodeUploadRequest, CodeUploadResult, ContractCallRequest, ContractExecResult, ContractInstantiateResult, InstantiateRequestV1 } from '@polkadot/types/interfaces/contracts/types.ts';
import type { BlockStats } from '@polkadot/types/interfaces/dev/types.ts';
import type { CreatedBlock } from '@polkadot/types/interfaces/engine/types.ts';
import type { EthAccount, EthCallRequest, EthFeeHistory, EthFilter, EthFilterChanges, EthLog, EthReceipt, EthRichBlock, EthSubKind, EthSubParams, EthSyncStatus, EthTransaction, EthTransactionRequest, EthWork } from '@polkadot/types/interfaces/eth/types.ts';
import type { Extrinsic } from '@polkadot/types/interfaces/extrinsics/types.ts';
import type { EncodedFinalityProofs, JustificationNotification, ReportedRoundStates } from '@polkadot/types/interfaces/grandpa/types.ts';
import type { MmrHash, MmrLeafBatchProof } from '@polkadot/types/interfaces/mmr/types.ts';
import type { StorageKind } from '@polkadot/types/interfaces/offchain/types.ts';
import type { FeeDetails, RuntimeDispatchInfoV1 } from '@polkadot/types/interfaces/payment/types.ts';
import type { RpcMethods } from '@polkadot/types/interfaces/rpc/types.ts';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from '@polkadot/types/interfaces/runtime/types.ts';
import type { MigrationStatusResult, ReadProof, RuntimeVersion, TraceBlockResponse } from '@polkadot/types/interfaces/state/types.ts';
import type { ApplyExtrinsicResult, ChainProperties, ChainType, Health, NetworkState, NodeRole, PeerInfo, SyncState } from '@polkadot/types/interfaces/system/types.ts';
import type { IExtrinsic, Observable } from '@polkadot/types/types/index.ts';

export type __AugmentedRpc = AugmentedRpc<() => unknown>;

declare module '@polkadot/rpc-core/types/jsonrpc.ts' {
