...
import '@polkadot/api-base/types/events.ts';

import type { ApiTypes, AugmentedEvent } from '@polkadot/api-base/types/index.ts';
import type { Bytes, Null, Option, Result, U8aFixed, Vec, bool, u128, u16, u32, u64 } from '@polkadot/types-codec/index.ts';
import type { ITuple } from '@polkadot/types-codec/types/index.ts';
import type { AccountId32, H256, Perbill } from '@polkadot/types/interfaces/runtime/types.ts';
import type { FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletCreditcoinAddress, PalletCreditcoinAskOrder, PalletCreditcoinAskOrderId, PalletCreditcoinBidOrder, PalletCreditcoinBidOrderId, PalletCreditcoinCollectCoinsCollectedCoins, PalletCreditcoinCollectCoinsUnverifiedCollectedCoins, PalletCreditcoinDealOrder, PalletCreditcoinDealOrderId, PalletCreditcoinLegacySighash, PalletCreditcoinOcwErrorsVerificationFailureCause, PalletCreditcoinOffer, PalletCreditcoinOfferId, PalletCreditcoinTransfer, PalletImOnlineSr25519AppSr25519Public, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsPoolState, PalletStakingExposure, PalletStakingForcing, PalletStakingValidatorPrefs, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup.ts';

export type __AugmentedEvent<ApiType extends ApiTypes> = AugmentedEvent<ApiType>;

declare module '@polkadot/api-base/types/events.ts' {
