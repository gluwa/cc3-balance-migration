...
import '@polkadot/types/lookup.ts';

import type { Data } from '@polkadot/types/mod.ts';
import type { BTreeMap, Bytes, Compact, Enum, Null, Option, Result, Set, Struct, Text, U256, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec/index.ts';
import type { ITuple } from '@polkadot/types-codec/types/index.ts';
import type { OpaqueMultiaddr, OpaquePeerId } from '@polkadot/types/interfaces/imOnline/types.ts';
import type { AccountId32, Call, H160, H256, MultiAddress, Perbill, Percent } from '@polkadot/types/interfaces/runtime/types.ts';
import type { Event } from '@polkadot/types/interfaces/system/types.ts';

declare module '@polkadot/types/lookup.ts' {
